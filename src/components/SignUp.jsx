...
function CalendarPicker({ value, onChange, onClose }) {
  ...
  const initDate = value ? new Date(value) : new Date(2000, 0, 1);
  ...
  const yearList = Array.from({ length: thisYear - 1919 }, (_, i) => thisYear - i);
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
          <span style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text)' }}>생년월일 선택</span>
        ...
        <div style={{ position: 'relative', marginBottom: '8px' }}>
          <button type="button" onClick={() => setShowYearList(v => !v)}
            style={{
              width: '100%', background: '#334155', border: 'none',
          ...
          {showYearList && (
            <div style={{
              ...
              borderRadius: '10px', maxHeight: '160px', overflowY: 'auto',
              ...
              {yearList.map(y => (
                <button key={y} type="button"
                  ...
                  style={{
                    width: '100%',
                    background: y === year ? 'var(--accent, #6366f1)' : 'transparent',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
          <button type="button" onClick={prevMonth}
            style={{ background: 'none', border: 'none', color: 'var(--text)', cursor: 'pointer', fontSize: '20px', padding: '0 8px' }}>
            ‹
          </button>
          <span style={{ fontWeight: 600, fontSize: '14px', color: 'var(--text)' }}>{month + 1}월</span>
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button type="button" onClick={handleConfirm} disabled={!tempDay}
            style={{
              flex: 2, padding: '10px 0', borderRadius: '10px', border: 'none',
              background: tempDay ? 'var(--accent, #6366f1)' : '#334155',
...
function SignUp({ goLogin, goHome }) {
  ...
  const [form, setForm] = useState({
    ...
    birthdate: '', gender: '', sleepGoal: '7', wakeTime: '07:00', sleepIssue: [],
  });
              ...
              <div className="auth-input-group">
                ...
                <div className="auth-input-wrap">
                  ...
                  <input type={showPw ? 'text' : 'password'}
                    ...
                    placeholder="비밀번호를 입력하세요" value={form.password}
              ...
              <div className="auth-input-group">
                ...
                <div className="auth-input-wrap">
                  ...
                  <input type="password"
                    ...
                    placeholder="비밀번호를 다시 입력하세요" value={form.passwordConfirm}
              ...
              <div className="auth-input-group">
                ...
                <div
                  ...
                  style={{
                    ...
                    background: 'var(--input-bg, transparent)', userSelect: 'none',
                  }}
                >
                  <span style={{ fontSize: '16px', lineHeight: 1 }}>📅</span>
                  <span style={{ flex: 1, fontSize: '14px', color: form.birthdate ? 'var(--text)' : 'var(--muted)' }}>
                    {form.birthdate
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  {[{ val: 'M', label: '남성' }, { val: 'F', label: '여성' }].map(({ val, label }) => (
                    <label key={val} style={{
                      ...
                      <input type="checkbox" checked={form.gender === val}
          ...
          <>
            ...
            <div className="auth-form">
              ...
              <div className="auth-input-group">
                ...
                <div className="auth-input-wrap">
                  <span className="auth-input-icon">⏰</span>
                  <input type="time" className="auth-input" value={form.wakeTime}
